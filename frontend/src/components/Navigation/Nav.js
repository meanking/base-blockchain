    ...
    <div>
        ...
        <div className="max-w-6xl mx-auto px-4">
            ...
            <div className="flex space-x-4">
                ...
                <a href="https://github.com/meanking/base-blockchain" target="_blank" className="py-5 px-3 text-gray-700 hover:text-gray-900 dark:text-white">Github</a>
        ...
        <div className="mobile-menu hidden md:hidden">
            ...
            <a href="https://github.com/meanking/base-blockchain" target="_blank" className="block py-2 px-4 text-sm hover:bg-gray-200 dark:hover:bg-[#0d121f] dark:text-white">Github</a>
